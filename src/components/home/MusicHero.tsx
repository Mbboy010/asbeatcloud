    ...
    <div className="min-h-[33rem] md:min-h-[30rem] flex items-center justify-center px-4 md:px-6 lg:px-10 relative overflow-hidden">
      <div className="w-full h-[32rem] md:h-auto rounded-lg flex items-center justify-center py-1 md:py-16 relative">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(https://fra.cloud.appwrite.io/v1/storage/buckets/6849a34c0027417cde77/files/688219a70036ab26e2b8/view?project=6840dd66001574a22f81&mode=admin)`,
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            filter: 'blur(5px)', // Blur only applies to the background
            zIndex: 0, // Ensure background stays behind content
          }}
        />
