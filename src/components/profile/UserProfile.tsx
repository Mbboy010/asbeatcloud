...
<div className="text-gray-200 p-6 rounded-lg">
  ...
  <p
   ...
   <span className="mt-[0.20rem]">  {userData.followers >= 1000 && <VerificationIcon className="ml-1  h-5 w-5" />}</span>
  </div>
              <div>
    ...
    >
      ...
      />
        ...
        >
                  ...
                  <button type="submit" className="px-4 py-2 bg-red-500 rounded hover:bg-red-400">
                    Submit Report
                  </button>
    </div>
    </form>
